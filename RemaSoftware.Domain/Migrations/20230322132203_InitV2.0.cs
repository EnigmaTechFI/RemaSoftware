        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number_Piece = table.Column<int>(type: "int", nullable: false),
                    Number_Piece_Now = table.Column<int>(type: "int", nullable: false),
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPrompted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    UseForStatics = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ddt_Out_ID = table.Column<int>(type: "int", nullable: false),
                    NumberPieces = table.Column<int>(type: "int", nullable: false),
                    TypePieces = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ddt_Associations", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ddt_Associations_Ddt_In_ID",
